# AS BAL MSS ORG - Modèle logique - API Messagerie Sécurisée de Santé (MSSanté) v0.1.0-snapshot

## Logical Model: AS BAL MSS ORG - Modèle logique 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.mss|current/StructureDefinition/StructureDefinition-as-bal-mss-org.json)
...
Other representations of profile: [CSV](../StructureDefinition-as-bal-mss-org.csv), [Excel](../StructureDefinition-as-bal-mss-org.xlsx) 
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-06-18T15:49:17+00:00",
