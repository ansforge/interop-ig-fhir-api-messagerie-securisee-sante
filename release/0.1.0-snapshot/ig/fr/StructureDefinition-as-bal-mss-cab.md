...
## Modèle logique: AS BAL MSS CAB - Modèle logique 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.mss|current/StructureDefinition/as-bal-mss-cab)
...
Autres représentations du profil : [CSV](../StructureDefinition-as-bal-mss-cab.csv), [Excel](../StructureDefinition-as-bal-mss-cab.xlsx) 
