...
* rest.resource[=].profile = "https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-organization"
...
* rest.resource[=].profile = "https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitioner"
* rest.resource[=].extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-CapabilityStatement.rest.resource.conditionalPatch"
* rest.resource[=].extension[=].valueBoolean = true
* rest.resource[=].interaction[+].code = #patch
...
* rest.resource[=].profile = "https://interop.esante.gouv.fr/ig/fhir/annuaire/StructureDefinition/as-practitionerrole"
* rest.resource[=].extension[+].url = "http://hl7.org/fhir/5.0/StructureDefinition/extension-CapabilityStatement.rest.resource.conditionalPatch"
* rest.resource[=].extension[=].valueBoolean = true
* rest.resource[=].interaction[+].code = #patch
