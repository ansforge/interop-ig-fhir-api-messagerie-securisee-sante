...
<p>L'endpoint PATCH de l'API MSSanté est en cours de développement. Cette page décrit le comportement attendu des opérations d'écriture, qui seront disponibles lors de l'ouverture de cet endpoint.</p>
</blockquote>
