...
<p>L'API Annuaire Santé est actuellement en lecture seule. Cette page décrit le comportement attendu pour les opérations d'écriture, en vue d'une future ouverture de l'endpoint PATCH.</p>
</blockquote>
