# Resource API Messagerie Sécurisée de Santé (MSSanté)
...
```json
{
  ...
  "description" : "Implementation Guide décrivant l'API FHIR pour la messagerie sécurisée de santé (MSSanté)",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://interop.esante.gouv.fr/ig/fhir/mss/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
