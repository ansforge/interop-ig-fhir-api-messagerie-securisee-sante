...
## Modèle logique: AS BAL MSS PER - Modèle logique 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.mss|current/StructureDefinition/as-bal-mss-per)
...
Autres représentations du profil : [CSV](../StructureDefinition-as-bal-mss-per.csv), [Excel](../StructureDefinition-as-bal-mss-per.xlsx) 
